...
<div class="container acesso">
    ...
    <div class="row">
        ...
        <div class="form-group col-12 col-sm-12 d-flex align-items-center">
            ...
            <input id="inputField" type="text" class="form-control"
                style="width:20%; margin-left:10px; border-radius:0;" placeholder="Buscar por Matricula ou Nome">

            <select id="selectField" class="form-control" style="width:20%; display: none; border-radius:0;"></select>

            <button class="btn-desktop" type="button" id="buscar"
                style="margin-left:5px; border-radius:0;">Buscar</button>
            ...
            <div style="margin:5px; width:50%;">
                <select id="gympassSelect" class="form-control gympass-select"
                    style="width:40%; display: none; border-radius:0;"></select>
    ...
    <div class="card p-2">
        <div class="card-header text-center" style="min-height:300px; max-height:300px;">
            <img src="{{ asset('img/defaultAvatarPng2.png') }}" alt="Imagem do aluno" class="img-thumbnail"
                id="foto_avatar" width="280px" height="240px" style="max-height:240px;">
        </div>
        <div class="card-body">
    ...
    function getEmpresasByIdweb(vendas_url_local, idweb) {
        ...
        $.get(vendas_url_local + '/' + formattedId + '/alunosmf', function(data) {
            ...
            data.forEach(function(item) {
                $('#alunos_multifilai').append('<option value="' + item.id + '">' + item.id + '-' + item
                    .name + '</option>');
            });
        });
    ...
    $('#searchButton').click(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#descricaoPlano').text(
                'Plano Gympass'); // Substitua por dados reais, se disponíveis
                $('#data_venct').text(
                'Vencimento Gympass'); // Substitua por dados reais, se disponíveis
